...
//  Tadam
//
//  Created by Denis Bystruev on 30.10.2020.
//
//  Derived from https://noahgilmore.com/blog/dark-mode-uicolor-compatibility

import UIKit

public enum ColorCompatibility {
    public static var isLight: Bool { UIScreen.main.traitCollection.userInterfaceStyle == .light }
